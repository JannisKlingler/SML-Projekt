...
\title[Koltchinskii \& Panchenko]{Überschrift}
...
\begin{document}
	...
	\input{Jannis/PräsentaionJannis}
	\input{Sebastian/PräsentaionSebastian}
	\input{Niklas/PräsentaionNiklas}
	\input{Clemens/PräsentaionClemens}
	\input{Ben/PräsentaionBen}
