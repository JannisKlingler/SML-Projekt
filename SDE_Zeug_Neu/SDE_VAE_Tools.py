...
class SDE_Variational_Autoencoder(tf.keras.Model):
    def __init__(self, M, N, encoder, derivatives, reconstructor, decoder, custom_loss, reconstruct_smoothly=True):
        ...
        self.reconstruct_smoothly = reconstruct_smoothly
...
'''
class SDE_Variational_Autoencoder(tf.keras.Model):
    def __init__(self, encoder, reconstructor, decoder, custom_loss, reconstruct_smoothly=True):
        super(SDE_Variational_Autoencoder, self).__init__()
        #self.outputs = ['a','b','c','d','e']
        self.encoder = encoder
        self.decoder = decoder
