...
\begin{document}
	...
	\input{Jannis/PräsentationJannis}
	\input{Sebastian/PräsentationSebastian}
	\input{Niklas/PräsentationNiklas}
	\input{Clemens/PräsentationClemens}
	\input{Ben/PräsentationBen}
