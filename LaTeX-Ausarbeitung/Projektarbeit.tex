...
\begin{document}
	...
	\begin{center}
		\begin{tabular}{|l|l|}
			...
			\hline
			$\z, \x$ &  \makecell{Zufallsvariablen oder zufällig verteilte Vektoren als Realisierung \\einer Zufallsvariablen werden wir mit Kleinbuchstaben in fetter\\ Schriftstärke notieren.}  \\
			\hline
			...
			\hline
			$\mathbf{X}, \mathbf{M}, \mathbf{I} $ & \makecell{Zufällig verteilte Matrizen wie Datensätze notieren wir mit Groß-\\buchstaben in fetter Schriftstärke. $\mathbf{I}$ ist die Einheitsmatrix} \\
			\hline
