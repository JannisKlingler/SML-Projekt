...
\begin{document}
	...
	\emph{Bemerkung:} Entsprechend der Notation, die uns beim recherchieren zum Thema in der Fachliteratur begegnet ist, werden auch wir in der Notation nicht zwischen Verteilung und Dichtefunktion unterscheiden.\\
	...
	Zuerst wird eine latente Darstellung $\z \sim  p(\z)$  gezogen. Mit dieser wird  $\x \sim  p(\x|\z)$ nun durch eine bedingte Verteilung ermittelt. So lässt sich $p(\x)$ über Marginalisierung durch ein Integral über alle latenten Werte beschreiben.
	\begin{align*}
